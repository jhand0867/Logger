    ...
    class SolicitedStatusFN : SolicitedStatus
    {
        ...
        public override bool writeData(List<typeRec> typeRecs, string Key, string logID)
        {
            foreach (typeRec r in typeRecs)
            {
                ...
                string sql = @"INSERT INTO solicitedStatusFN([logkey],[rectype],[messageClass],[messageSubClass],
                            ...
                            " VALUES('" + r.typeIndex + "','" + ss.Rectype + "','" + ss.MessageClass + "','" + ss.MessageSubClass + "','" + ss.Luno + "','" +
