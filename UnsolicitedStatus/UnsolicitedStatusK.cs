...
namespace Logger
{
    ...
    class UnsolicitedStatusK : UnsolicitedStatus
    {
        ...
        public override bool writeData(List<typeRec> typeRecs, string Key, string logID)
        {
            ...
            {
                unsolicitedStaK us = parseData(r.typeContent);

                string sql = @"INSERT INTO unsolicitedStatusK([logkey],[rectype],[messageClass],[messageSubclass],[luno],
        ...
        public unsolicitedStaK parseData(string r)
        {
            unsolicitedStaK us = new unsolicitedStaK();
