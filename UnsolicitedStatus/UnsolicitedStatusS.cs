...
namespace Logger
{
    ...
    class UnsolicitedStatusS : UnsolicitedStatus
    {
        ...
        public override bool writeData(List<typeRec> typeRecs, string Key, string logID)
        {
            ...
            {
                unsolicitedStaS us = parseData(r.typeContent);

                string sql = @"INSERT INTO unsolicitedStatusS([logkey],[rectype],[messageClass],[messageSubclass],[luno],
        ...
        public unsolicitedStaS parseData(string r)
        {
            unsolicitedStaS us = new unsolicitedStaS();
