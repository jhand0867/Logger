...
namespace Logger
{
    ...
    class UnsolicitedStatus5C : UnsolicitedStatus
    {
        ...
        public override bool writeData(List<typeRec> typeRecs, string Key, string logID)
        {
            ...
            {
                unsolicitedSta5C us = parseData(r.typeContent);

                string sql = @"INSERT INTO unsolicitedStatus5c([logkey],[rectype],[messageClass],[messageSubclass],[luno], 
        ...
        public unsolicitedSta5C parseData(string r)
        {
            unsolicitedSta5C us = new unsolicitedSta5C();
