...
namespace Logger
{
    ...
    class UnsolicitedStatusD : UnsolicitedStatus
    {
        ...
        public override bool writeData(List<typeRec> typeRecs, string Key, string logID)
        {
            ...
            {
                unsolicitedStaD us = parseData(r.typeContent);

                string sql = @"INSERT INTO unsolicitedStatusD([logkey],[rectype],[messageClass],[messageSubclass],[luno],
        ...
        public unsolicitedStaD parseData(string r)
        {
            unsolicitedStaD us = new unsolicitedStaD();
