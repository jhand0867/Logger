...
namespace Logger
{
    ...
    class UnsolicitedStatus71 : UnsolicitedStatus
    {
        ...
        public override bool writeData(List<typeRec> typeRecs, string Key, string logID)
        {
            ...
            {
                unsolicitedSta71 us = parseData(r.typeContent);

                string sql = @"INSERT INTO unsolicitedStatus71([logkey],[rectype],[messageClass],[messageSubclass],[luno],
        ...
        public unsolicitedSta71 parseData(string r)
        {
            unsolicitedSta71 us = new unsolicitedSta71();
