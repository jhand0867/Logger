...
namespace Logger
{
    ...
    class UnsolicitedStatusH : UnsolicitedStatus
    {
        ...
        public override bool writeData(List<typeRec> typeRecs, string Key, string logID)
        {
            ...
            {
                unsolicitedStaH us = parseData(r.typeContent);

                string sql = @"INSERT INTO unsolicitedStatusH([logkey],[rectype],[messageClass],[messageSubclass],[luno],
        ...
        public unsolicitedStaH parseData(string r)
        {
            unsolicitedStaH us = new unsolicitedStaH();
