...
namespace Logger
{
    ...
    class UnsolicitedStatusM : UnsolicitedStatus
    {
        ...
        public override bool writeData(List<typeRec> typeRecs, string Key, string logID)
        {
            ...
            {
                unsolicitedStaM us = parseData(r.typeContent);

                string sql = @"INSERT INTO unsolicitedStatusM([logkey],[rectype],[messageClass],[messageSubclass],[luno],
        ...
        public unsolicitedStaM parseData(string r)
        {
            unsolicitedStaM us = new unsolicitedStaM();
