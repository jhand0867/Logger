...
namespace Logger
{
    ...
    struct unsolicitedStaY
    {
        ...
        public string CoinDispense { get => coinDispense; set => coinDispense = value; }
    ...
    class UnsolicitedStatusY : UnsolicitedStatus
    {
        ...
        public override bool writeData(List<typeRec> typeRecs, string Key, string logID)
        {
            ...
            {
                unsolicitedStaY us = parseData(r.typeContent);

                string sql = @"INSERT INTO unsolicitedStatusY([logkey],[rectype],[messageClass],[messageSubclass],[luno],
	                        [dig],[deviceStatus],[coinDispense],[errorSeverity],[diagnosticStatus], 
                            [suppliesStatus],[prjkey],[logID]) " +
                            " VALUES('" + r.typeIndex + "','" + us.Rectype + "','" + us.MessageClass + "','" +
                               us.MessageSubclass + "','" + us.Luno + "','" +
                               us.Dig + "','" + us.DeviceStatus + "','" + us.CoinDispense + "','" + us.ErrorSeverity + "','" +
        ...
        public unsolicitedStaY parseData(string r)
        {
            unsolicitedStaY us = new unsolicitedStaY();
            ...
            us.CoinDispense = tmpTypes[i].Substring(2, tmpTypes[i].Length - 2);
