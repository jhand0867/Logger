...
namespace Logger
{
    ...
    class UnsolicitedStatusL : UnsolicitedStatus
    {
        ...
        public override bool writeData(List<typeRec> typeRecs, string Key, string logID)
        {
            ...
            {
                unsolicitedStaL us = parseData(r.typeContent);

                string sql = @"INSERT INTO unsolicitedStatusL([logkey],[rectype],[messageClass],[messageSubclass],[luno],
        ...
        public unsolicitedStaL parseData(string r)
        {
            unsolicitedStaL us = new unsolicitedStaL();
