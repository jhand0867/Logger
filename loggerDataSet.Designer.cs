...
namespace Logger {
    ...
    public partial class loggerDataSet : global::System.Data.DataSet {
        ...
        public partial class logsDataTable : global::System.Data.TypedTableBase<logsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public logsRow AddlogsRow(string logFile, System.DateTime uploadDate) {
...
namespace Logger.loggerDataSetTableAdapters {
    ...
    public partial class logsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[logs] ([logFile], [uploadDate]) VALUES (@logFile, @uploadDate)" +
                "";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT logFile, uploadDate FROM dbo.logs";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT logFile, uploadDate\r\nFROM   logs\r\nWHERE (prjKey = @pkey)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@pkey", global::System.Data.SqlDbType.VarChar, 100, global::System.Data.ParameterDirection.Input, 0, 0, "prjKey", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(loggerDataSet.logsDataTable dataTable) {
        ...
        public virtual loggerDataSet.logsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            loggerDataSet.logsDataTable dataTable = new loggerDataSet.logsDataTable();
        ...
        public virtual int FillBy(loggerDataSet.logsDataTable dataTable, string pkey) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((pkey == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(pkey));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(loggerDataSet.logsDataTable dataTable) {
        ...
        public virtual int Insert(string logFile, global::System.Nullable<global::System.DateTime> uploadDate) {
            if ((logFile == null)) {
                this.Adapter.InsertCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.InsertCommand.Parameters[0].Value = ((string)(logFile));
            }
            if ((uploadDate.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[1].Value = ((System.DateTime)(uploadDate.Value));
            }
            else {
